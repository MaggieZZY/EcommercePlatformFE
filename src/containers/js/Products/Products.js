...
import {getProductsByCategory, sortProducts} from "../../../actions/products.action";
...
export default connect(mapStateToProps, {getProductsByCategory, sortProducts})(Products);
