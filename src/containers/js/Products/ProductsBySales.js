...
import {getProductsBySales, sortProducts} from "../../../actions/products.action";
...
class ProductsBySales extends React.Component {
...
export default connect(mapStateToProps, {getProductsBySales, sortProducts})(ProductsBySales);
